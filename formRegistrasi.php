...
if (isset($_POST['Login'])){
	...
	$password=$_POST['password'];
		...
		$query=mysqli_query($connect,"SELECT * FROM tbl_user WHERE username='".$username."' and password='".$password."'");
		...
		if($cek){
			...
			?><script language="javascript">document.location.href="index.html";</script><?php
...
<?php
		...
		$query = mysqli_query($connect,"insert into tbl_user (nama_user, email_user, username, password, jekel)
