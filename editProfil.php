...
if(isset($_SESSION['username'])){
	...
	if(isset($_POST['Edit']))
	{
		mysqli_query($connect,"UPDATE tbl_user SET nama_user='$_POST[nama]', no_hp='$_POST[no_hp]', no_rek='$_POST[no_rek]', nama_rek='$_POST[nama_rek]', tgl_lahir='$_POST[tgl_lahir]', jekel='$_POST[jekel]', alamat='$_POST[alamat]', email_user='$_POST[email]', tipe_id='$_POST[tipe_id]', no_id='$_POST[no_id]' WHERE id_user= '$_POST[id_user]'");
